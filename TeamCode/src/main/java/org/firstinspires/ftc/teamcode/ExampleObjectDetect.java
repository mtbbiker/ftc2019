...
//How to use a camera to detect an Object and follow the Object
@Autonomous(name = "ExampleObjectDetect", group = "AutoOpTraining")
@Disabled
public class ExampleObjectDetect extends LinearOpMode {
